...
((draw-pixmap CampoJugadores) "bola.bmp" (make-posn 500 220))
...
(define (jugadoresG1 posx posy lad )
  (if (equal? lad 'u)
      ...
      ((draw-pixmap CampoJugadores) "defensa.bmp" (make-posn posx posy))
      (if (equal? lad 'd)
          ;((draw-solid-rectangle CampoJugadores) (make-posn posx posy) 10 10 "black")
          ((draw-pixmap CampoJugadores) "defensa.bmp" (make-posn posx posy))
          (if (equal? lad 'l)
...
(define (jugadoresG2 posx posy lad )
  (if (equal? lad 'u)
      ;((draw-solid-rectangle CampoJugadores) (make-posn posx posy) 10 10 "black")
      ((draw-pixmap CampoJugadores) "delantero.bmp" (make-posn posx posy))
      (if (equal? lad 'd)
          ;((draw-solid-rectangle CampoJugadores) (make-posn posx posy) 10 10 "black")
          ((draw-pixmap CampoJugadores) "delantero.bmp" (make-posn posx posy))
          (if (equal? lad 'l)
